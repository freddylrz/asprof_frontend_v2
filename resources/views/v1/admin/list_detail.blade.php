...
@section('content')
    <style>
        ...
        .dataTables_wrapper .table .reqId, #check {
        ...
        .dataTables_wrapper .table th.text-center {
            vertical-align: middle; /* Ensure content centers in cells vertically */
        }

    </style>
    <div class="mb-5">
        <a class="btn btn-secondary btn-sm fa-pull-left" href="/admin/list-data"><i class="fa fa-arrow-alt-circle-left"></i> Back</a>
    </div>
    <div class="pct-body">
        <div class="card">
            <div class="card-header"><h3><i class="fas fa-list mb-2" style="font-size: 2.5rem;"></i> List Data Peserta</h3></div>
            ...
            <div class="card-footer">
                ...
                <button class="btn btn-primary btn-sm" data-bs-target="#modal-upload" data-bs-toggle="modal" data-stat="2"><i class="fa fa-plus"></i> Add Data</button>
                <button class="btn btn-success fa-pull-right btn-sm btnAction" data-stat="1"><i class="fa fa-check-circle"></i> Submit</button>
                <button class="btn btn-danger fa-pull-right m-r-10 btn-sm btnAction" data-stat="0"><i class="fa fa-trash"></i> Delete</button>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body task-card">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" required id="inputFile" name="fileUp" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                    </div>
    ...
    <div class="modal fade" id="modal-detail">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <button class="btn btn-primary btnSIP" type="button" id="openModalKTP" data-stat="0"><i class="fas fa-eye"></i>
                                                    Lihat KTP
                                                </button>
                                            </div>
                                        </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6 col-12 pt-3 pe-xl-3" style="">
                                    ...
                                    <div class="row" style="border: 1px solid #ddd; border-radius: 10px; padding-top: 10px">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <button class="btn btn-primary btnSIP" type="button" id="openModalSTR" data-stat="1"><i class="fas fa-eye"></i>
                                                    Lihat STR
                                                </button>
                                            </div>
                                            <div class="form-group">
                ...
                <div class="modal-footer">
                    <button class="btn btn-danger btnVal" type="button" id="btnDelete"><i class="fas fa-trash"></i> Delete</button>
