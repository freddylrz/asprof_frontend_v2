    ...
    <section class=" overflow-hidden" style="background-image: url({{ asset('assets/images/landing/img-headerbg.jpg') }}">
        <div class="container mb-0">
            ...
            <div class="row align-items-start d-none d-md-flex">
                <div class="col-12 col-xl-6 wow fadeInUp" data-wow-delay="0.2s" style="padding-left: 0px !important;">
                ...
                <div class="col-12 col-xl-6 wow fadeInUp" data-wow-delay="0.2s" style="padding-right: 0px !important;">
    ...
    <section class="bg-white overflow-hidden" style="background-image: url({{ asset('assets/images/landing/img-headerbg.png') }})">
        <div class="container title mb-0">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12 app_dotsContainer mt-20 wow fadeInLeft">
                    <style>
                        .app-link{
                    ...
                    <div class="app-link wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;padding-block: 10px !important;">
                    ...
                    <div class="app-link wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                        <i class="ti ti-caret-right f-30"></i><h5 class=" text-black">Menjaga kondisi finansial apabila terjadi tuntutan/gugatan.</h5>
                    </div>
                    <div class="app-link wow fadeInUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                    ...
                    <div class="app-link wow fadeInUp" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                    ...
                    <div class="app-link wow fadeInUp" data-wow-delay="0.8s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                    ...
                    <div class="app-link wow fadeInUp" data-wow-delay="0.10s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                    ...
                    <div class="app-link wow fadeInUp" data-wow-delay="0.12s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;padding-block: 10px !important;">
                        <i class="ti ti-caret-right f-30"></i><h5 class=" text-black f-w-500">Mendapatkan perlindungan hukum sepanjang melaksanakan tugas sesuai dengan standar pelayanan profesi, etika profesi,
                            standar prosedur operasional serta kebutuhan pasien, sesuai dengan UU No. 17 Tahun 2023 tentang Kesehatan.</h5>
                    </div>
                </div>
...
{{--                                <li style="display: list-item;">Memberikan perlindungan dan jaminan apabila ada tuntutan/gugatan dari pasien atau pihak ketiga lainnya yang--}}
{{--                                    mengalami kerugian, sebagai akibat dari tugas profesi yang dilakukan.</li>--}}
...
{{--                                <li style="display: list-item;">Mendapatkan perlindungan hukum sepanjang melaksanakan tugas sesuai dengan standar pelayanan profesi, etika profesi, --}}
{{--                                    standar prosedur operasional serta kebutuhan pasien, sesuai dengan UU No. 17 Tahun 2023 tentang Kesehatan.</li>--}}
{{--                            </ul>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
    ...
    <section class="bg-white overflow-hidden" style="background-image: url({{ asset('assets/images/landing/img-headerbg.jpg') }})">
        <div class="container title mb-0">
            <div class="row align-items-center">
              ...
              <div class="col-md-4">
                    <div class="app-link wow fadeInUp txt" data-wow-delay="0.2s"
                         style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp; text-align: center !important;">
                ...
                <div class="col-md-4">
                    <div class="app-link wow fadeInUp txt" data-wow-delay="0.2s"
                        ...
                        <p class="text-desc mb-0"><b>Free</b> Sosialisasi & Edukasi untuk FASYANKES (Pelatihan <b>“Handling
                                Complaint”</b> khusus untuk Fasyankes)<span class="text-danger">*</span>.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="app-link wow fadeInUp txt" data-wow-delay="0.2s"
                        ...
                        <p class="text-desc mb-0">Pendampingan oleh team medikolegal pada saat terindikasi akan ada
                            gugatan maupun gugatan yang sudah masuk/diterima.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="app-link wow fadeInUp txt" data-wow-delay="0.2s"
                ...
                <div class="col-md-4">
                    <div class="app-link wow fadeInUp txt" data-wow-delay="0.2s"
                        ...
                        <p class="text-desc mb-0">Menggunakan sistem IT terkini dengan sistem keamanan berlapis
                            sehingga semua data tersimpan aman dan terpercaya.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="app-link wow fadeInUp txt" data-wow-delay="0.2s"
                ...
                <div class="col-md-12">
                            <div class="app-link wow premi fadeInUp" data-wow-delay="0.2s"
                                 style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp; background-color: #FDF3E7">
                                <div class="row">
...
{{--                    </div>--}}
{{--                    <div class="col-md-8">--}}
{{--                       <ol class="list-group list-group-numbered text-start" style="font-size: 1.3rem; font-weight: 500; margin: 0">--}}
{{--                            <li class="list-group-item">Persiapkan dokumen Anda seperti KTP, STR dan SIP. Setelah itu isi form dan unggah dokumen tersebut pada menu <a href="/pendaftaran" class="btn btn-sm  btn-primary" target="blank"> <i class="ti ti-forms me-1"></i> Daftar</a></li>--}}
{{--                            <li class="list-group-item">Data yang telah disubmit akan divalidasi oleh tim TuguBro, selanjutnya akan diinformasikan untuk melakukan konfirmasi pendaftaran melalui email</li>--}}
{{--                            <li class="list-group-item">Peserta dapat melakukan pembayaran dengan memilih metode pembayaran yang kami sediakan setelah melakukan konfirmasi pendaftaran</li>--}}
{{--                            <li class="list-group-item">E-sertifikat dapat diunduh pada dashboard peserta dengan melakukan login menggunakan nomor STR dan alamat email yang terdaftar melalui tombol <a class="btn btn-sm btn-success" href="/login"><i class="ti ti-login"></i> Masuk</a></li>--}}
